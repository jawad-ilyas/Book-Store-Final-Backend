...
import { addToCart, addToWishlist, getWishlist, removeFromCart, removeFromWishlist, updateCartItem } from "../controllers/userController.js";
...
router.route("/cart/remove").put(removeFromCart)
